...
@section('title', 'Create Coin Package')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create New Coin Package</h2>
        
        <form method="POST" action="{{ route('coin-packages.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="number" name="coins" id="coins" required
            ...
            <div>
                ...
                <input type="number" name="bonus_coins" id="bonus_coins" value="0"
                       class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg px-4 py-2"
                       placeholder="0">
            </div>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg px-4 py-2"
                          placeholder="Best value package"></textarea>
            </div>
