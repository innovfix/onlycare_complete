...
<div class="max-w-3xl mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create New Gift</h2>
        
        <form method="POST" action="{{ route('gifts.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="file" name="gift_icon" id="gift_icon" accept="image/jpeg,image/png,image/jpg,image/gif,image/avif" required
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Upload an image file (JPEG, PNG, JPG, GIF, AVIF - Max 2MB)</p>
                <div id="imagePreview" class="mt-3 hidden">
                    <img id="previewImg" src="" alt="Preview" class="w-32 h-32 object-cover rounded-lg border-2 border-gray-300 dark:border-gray-600">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" name="coins" id="coins" value="{{ old('coins') }}" min="1" step="1" required
