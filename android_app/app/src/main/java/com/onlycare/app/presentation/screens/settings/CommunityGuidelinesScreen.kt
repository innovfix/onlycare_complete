...
fun CommunityGuidelinesScreen(
    ...
    viewModel: CommunityGuidelinesViewModel = hiltViewModel()
) {
    val state by viewModel.state.collectAsState()
    val screenTitle = "Community Guidelines & Moderation Policy"
                    ...
                    when {
                        ...
                        !state.htmlContent.isNullOrBlank() -> {
                            ...
                            Box(
                                ...
                                Text(
                                    text = "No community guidelines content available.",
                                    color = TextSecondary
                                )
                            }
                        }
